...
public class User implements Serializable {
    ...
    public User(String id, String name, String password, String truename, String phone, String deptid, String paytype, Integer upload, Integer workstate, Date empcreatedate) {
        this.id = id;
        this.name = name;
