    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
                ...
                <li class="layui-nav-item"><a href="javascript:;" data-url="income.jsp" data-id='1' data-text="后台菜单">日常收支</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="Submit.jsp" data-id='1' data-text="后台菜单">我的提交</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="Approval.jsp" data-id='1' data-text="后台菜单">日常审批</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="employee.jsp" data-id='1' data-text="后台菜单">员工管理</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="client.jsp" data-id='1' data-text="后台菜单">客户管理</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="Authorizations.jsp" data-id='1' data-text="后台菜单">审批授权</a></li>
                <li class="layui-nav-item"><a href="javascript:;" data-url="Authorizations.jsp" data-id='1' data-text="后台菜单">设置</a>
