...
<div class="layui-tab">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <button class="layui-btn layui-btn-normal" id="select1" data-type="reload">查询</button>
            </form>
        ...
        <div class="layui-tab-item">
            <form class="layui-form" action="" method="post"  id="incomeDataFrm2" lay-filter="incomeDataFrm">
                ...
                <button class="layui-btn layui-btn-normal" id="select2" data-type="reload">查询</button>
            </form>
...
<script type="text/html" id="barDemo2Refuse">
    <a class="layui-btn layui-btn-xs" lay-event="Look" onclick="">查看</a>
    <a class="layui-btn layui-btn-xs" lay-event="Approve">通过</a>
</script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{fixed: 'right', width:205,title: '操作', align:'center', toolbar: '#barDemo2'}
            ]]
            ,page: true
        });
    });
